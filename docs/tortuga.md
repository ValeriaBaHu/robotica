...
<img src="../recursos/imgs/5.1.png" alt="Diagram" width="420">

* Terminal 2:
ros2 run turtlesim_catch_them_all turtle_spawner

<img src="../recursos/imgs/5.2.png" alt="Diagram" width="420">

* Terminal 3:
ros2 run turtlesim_catch_them_all turtle_controller
<img src="../recursos/imgs/5.3.png" alt="Diagram" width="420">
